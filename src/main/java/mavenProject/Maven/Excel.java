...
public class Excel {
	...
	File file = new File("C:\\Users\\sangeetha.kulasekara\\eclipse-workspace\\Maven\\TaskXL\\xltask.xlsx");

	public void writeExcel() throws IOException {
//		System.out.println("Enter Your File Name:");
//		String fileName = input.nextLine();
		//File file = new File("C:\\Users\\santhoshkumar.s\\eclipse-workspace\\Automation\\ExcelSheet\\TaskXL.xlsx");
